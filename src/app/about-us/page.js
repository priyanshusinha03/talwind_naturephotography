  ...
  return (
    <div className="">
      <div className="flex items-center justify-center h-screen bg-fixed bg-center bg-cover custom-img2">
        {/* <div className="absolute top-0 left-0 right-0 bottom-0 bg-cyan/70 z-[2]">
          <div className="p-5 text-white z-[2] mt-[25rem] ml-[30rem]">
            <h2 className="text-yellow-300 text-8xl font-bold">
              Chirag Paswan
            </h2>
            <p className="py-5 text-4xl ml-30">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 shadow-xl">
        ...
        <div>
          <div className="p-10 text-2xl bg-gray-600">
            <div className="text-center text-white mb-2">
              {" "}
              Follow Us Chirag Paswan
            </div>
            <div class="flex mt-5 space-x-6 justify-center sm:mt-0">
